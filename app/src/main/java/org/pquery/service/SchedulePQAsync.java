...
public class SchedulePQAsync extends AsyncTask<Void, ProgressInfo, RetrievePQListResult> implements CancelledListener, ProgressListener {

    private final String url;
    private Context cxt;

    public SchedulePQAsync(Context cxt, String url) {
        this.cxt = cxt;
        this.url = url;
    }
